...
func main() {
	...
	// Запускаем операцию генерации данных
	...
	if err != nil {
		...
		// Если данные были сгенерированы, сохраняем их в файл
		err := ioutil.WriteFile("generated_data.bin", data, 0644)
		if err != nil {
			log.Fatalf("Ошибка при записи данных в файл: %v", err)
		}
		fmt.Println("Данные успешно сгенерированы и записаны в файл.")
	}
}
